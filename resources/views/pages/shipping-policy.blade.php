<x-layouts.app title="Shipping & Delivery Policy - Sonakshi Fashion Hub">
    <div class="max-w-4xl mx-auto space-y-10">
        ...
        <div class="bg-surface-container-lowest p-8 sm:p-12 rounded-3xl border border-border-subtle shadow-xs space-y-8 font-body-md text-xs sm:text-sm text-charcoal-text leading-relaxed">
            ...
            <section class="space-y-3 border-t border-border-subtle pt-6">
